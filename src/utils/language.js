// src/utils/language.js (o src/data/language.js)

// Importa le icone delle bandiere (assicurati che i percorsi siano corretti nel tuo progetto)
...
export const languagesData = [
  ...
  { code: 'hu-HU', name: 'Hungary', src: flag_hu_HU },
  { code: 'ie-IE', name: 'Ireland', src: flag_ie_IE },
  { code: 'lu-LU', name: 'Luxembourg', src: flag_lu_LU },
  { code: 'no-NO', name: 'Norway', src: flag_no_NO },
  { code: 'pl-PL', name: 'Poland', src: flag_pl_PL },
  { code: 'pt-PT', name: 'Portugal', src: flag_pt_PT },
  { code: 'se-SE', name: 'Sweden', src: flag_se_SE },
  { code: 'sk-SK', name: 'Slovakia', src: flag_sk_SK },
  { code: 'tr-TR', name: 'Turkey', src: flag_tr_TR },
  { code: 'za-ZA', name: 'South Africa', src: flag_za_ZA },
];